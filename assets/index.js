...
if (!localStorage.getItem('hx')) {
    const hx = []
    localStorage.setItem('hx', JSON.stringify(hx))
} else{
    const hx = JSON.parse(localStorage.getItem('hx'))
